...
<a href="https://mudri.org">MUDRI</a>
...
І тримай бонус на бонус  ось промокод ACADEMY, який дає знижку 15% на усі набори MUDRI (тут має бути посилання на mudri.org) до кінця інтенсиву""",
...
А ще маєш подарунок від мене – промокод ACADEMY, який дає знижку 15% на усі набори MUDRI (тут має бути посилання на mudri.org)
