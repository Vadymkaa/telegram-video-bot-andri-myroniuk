...
# Додаткові файли для певних днів (ключ = день, значення = file_id + caption)
EXTRA_FILES = {
    2: {
        "file_id": "📎_ТВОЙ_FILE_ID_ДЛЯ_ДНЯ_2",  # заміни після того, як кине файл і зловиш file_id
        "caption": "📄 Обіцяний файл до другого дня 🚀"
    },
    4: {
        "file_id": "📎_ТВОЙ_FILE_ID_ДЛЯ_ДНЯ_4",
